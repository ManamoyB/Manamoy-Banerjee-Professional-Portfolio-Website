...
export default async function RecruiterPage() {
  const { education, projects, settings, skills } = await getPortfolioData();
    ...
    <>
      <SectionWrapper className="py-20">
        <PageHeader
          ...
          description={`${settings.name} is a ${primaryEducation?.degree ?? "BTech CSE"} student from ${primaryEducation?.institution ?? "SRM University"}${primaryEducation?.cgpa ? ` with a CGPA of ${primaryEducation.cgpa}` : ""}, focused on AI, full-stack development, and data science.`}
        />
      </SectionWrapper>
