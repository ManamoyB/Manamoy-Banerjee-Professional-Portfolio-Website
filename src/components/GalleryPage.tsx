...
export const GalleryPage: React.FC<GalleryPageProps> = ({ colors, theme }) => {
      ...
      case 'brainstorm':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full opacity-80" id={`svg-brainstorm-${title.replace(/\s+/g, '-').toLowerCase()}`}>
            <rect width="400" height="300" fill="#01030d" />
            ...
            <circle cx="200" cy="150" r="70" fill="none" stroke="#4f46e5" strokeWidth="2" strokeDasharray="3,3" />
            <path d="M 130 150 Q 200 100 270 150 T 410 150" fill="none" stroke="#818cf8" strokeWidth="1.5" />
            <text x="50" y="50" fill="#6366f1" fontSize="10" fontFamily="monospace">GRAD_DESCENT_STEP(W)</text>
            <text x="260" y="250" fill="#312e81" fontSize="9" fontFamily="monospace">alpha = 0.0125</text>
            {/* Draw mathematical neural structures */}
            <circle cx="160" cy="140" r="10" fill="#4f46e5" />
            <circle cx="240" cy="140" r="10" fill="#4f46e5" />
            <circle cx="200" cy="190" r="10" fill="#818cf8" />
            <line x1="160" y1="140" x2="200" y2="190" stroke="#818cf8" strokeWidth="1.5" />
            <line x1="240" y1="140" x2="200" y2="190" stroke="#818cf8" strokeWidth="1.5" />
          </svg>
        );
      case 'code-parser':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full opacity-80" id={`svg-codeparser-${title.replace(/\s+/g, '-').toLowerCase()}`}>
            <rect width="400" height="300" fill="#010d06" />
            <g opacity="0.2" fill="#10b981" fontFamily="monospace" fontSize="8">
              ...
              <text x="20" y="155" fill="#34d399" fontWeight="bold">{`// TIMER_AFTER : 8.12 MINUTES`}</text>
            </g>
            <rect x="220" y="60" width="140" height="150" rx="6" fill="#022c22" stroke="#10b981" strokeWidth="1" />
            <circle cx="245" cy="85" r="5" fill="#34d399" />
            <circle cx="270" cy="85" r="5" fill="#059669" />
            <path d="M 230 110 h 120" stroke="#047857" strokeWidth="1" />
            <polyline points="240,150 270,120 300,160 330,130" fill="none" stroke="#34d399" strokeWidth="1.5" />
          </svg>
        );
      case 'basketball-board':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full opacity-80" id={`svg-basketball-${title.replace(/\s+/g, '-').toLowerCase()}`}>
            <rect width="400" height="300" fill="#0b0502" />
            {/* Court boundary */}
            <rect x="30" y="30" width="340" height="240" fill="none" stroke="#ff6b35" strokeWidth="1" opacity="0.3" />
            {/* Play coordinates */}
            <circle cx="200" cy="150" r="40" fill="none" stroke="#ff6b35" strokeWidth="1" opacity="0.4" />
            <path d="M 30 150 A 40 40 0 0 0 110 150" fill="none" stroke="#ff6b35" strokeWidth="1" opacity="0.4" />
            <path d="M 370 150 A 40 40 0 0 0 290 150" fill="none" stroke="#ff6b35" strokeWidth="1" opacity="0.4" />
            {/* Custom Playbook Strategy Vectors */}
            <text x="50" y="60" fill="#ff6b35" fontSize="12" fontFamily="sans-serif" fontWeight="black">GAME 7 DEFENSE</text>
            <circle cx="120" cy="100" r="8" fill="none" stroke="#ff6b35" strokeWidth="2" />
            <text x="116" y="104" fill="#ff6b35" fontSize="10" fontWeight="bold">X</text>
            <circle cx="160" cy="140" r="8" fill="none" stroke="#ff6b35" strokeWidth="2" />
            <text x="156" y="144" fill="#ff6b35" fontSize="10" fontWeight="bold">X</text>
            <circle cx="270" cy="130" r="8" fill="none" stroke="#059669" strokeWidth="2" />
            <text x="266" y="134" fill="#34d399" fontSize="10" fontWeight="bold">O</text>
            {/* Screen arrow */}
            <path d="M 124 104 Q 200 95 262 126" fill="none" stroke="#60a5fa" strokeWidth="1.5" strokeDasharray="3,3" />
            <polygon points="262,126 254,122 257,130" fill="#60a5fa" />
          </svg>
        );
      case 'hack-trophy':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full opacity-85" id={`svg-hackathon-${title.replace(/\s+/g, '-').toLowerCase()}`}>
            <rect width="400" height="300" fill="#0a0212" />
            <g stroke="#a855f7" strokeWidth="0.5" opacity="0.2">
              <polygon points="200,10 370,150 200,290 30,150" fill="none" />
              <line x1="200" y1="0" x2="200" y2="300" />
              <line x1="0" y1="150" x2="400" y2="150" />
            </g>
            {/* Trophy Illustration */}
            <path d="M150,70 h100 v60 c0,25 -20,45 -50,45 s-50,-20 -50,-45 Z" fill="#1e1b4b" stroke="#a855f7" strokeWidth="2" />
            <rect x="188" y="175" width="24" height="40" fill="#090514" stroke="#a855f7" strokeWidth="1.5" />
            <rect x="140" y="215" width="120" height="15" rx="3" fill="#311042" stroke="#d946ef" strokeWidth="2" />
            {/* Large golden star */}
            <circle cx="200" cy="120" r="24" fill="#ea580c" />
            <text x="193" y="127" fill="#fef08a" fontSize="20" fontWeight="bold">★</text>
            <text x="147" y="260" fill="#d946ef" fontSize="12" fontFamily="monospace" fontWeight="black">RANK 1 OUTCOME</text>
          </svg>
        );
      case 'bigquery-nodes':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full opacity-80" id={`svg-bigquery-${title.replace(/\s+/g, '-').toLowerCase()}`}>
            <rect width="400" height="300" fill="#050811" />
            ...
            <circle cx="200" cy="60" r="14" fill="#1e1b4b" stroke="#3b82f6" strokeWidth="1.5" />
            <text x="181" y="100" fill="#60a5fa" fontSize="8" fontFamily="monospace">GCP BigQuery</text>
            
            <circle cx="290" cy="190" r="14" fill="#1e1b4b" stroke="#3b82f6" strokeWidth="1.5" />
            <text x="270" y="225" fill="#60a5fa" fontSize="8" fontFamily="monospace">IBM RAG Mod</text>
            
            <circle cx="110" cy="190" r="14" fill="#1e1b4b" stroke="#3b82f6" strokeWidth="1.5" />
            <text x="96" y="225" fill="#60a5fa" fontSize="8" fontFamily="monospace">Regression</text>
            
            {/* Draw connectors */}
            <line x1="200" y1="74" x2="290" y2="176" stroke="#f59e0b" strokeWidth="1.5" strokeDasharray="3,3" />
            <line x1="200" y1="74" x2="110" y2="176" stroke="#f59e0b" strokeWidth="1.5" strokeDasharray="3,3" />
            <line x1="110" y1="190" x2="276" y2="190" stroke="#10b981" strokeWidth="1" />
            <text x="175" y="180" fill="#10b981" fontSize="9" fontFamily="monospace">SYNCED</text>
          </svg>
        );
      default:
        // workstation
  ...
  const renderPlaybackSvg = (type: string) => {
    switch (type) {
      case 'basketball-play':
        return (
          <svg viewBox="0 0 600 350" className="w-full h-full">
            <rect width="600" height="350" fill="#0c0502" />
            {/* Interactive play court vectors in motion */}
            <g opacity={isVideoPlaying ? "0.6" : "0.3"} stroke="#ff6b35" strokeWidth="1.5">
            ...
            {isVideoPlaying ? (
              <g>
                ...
                />
                <text x="360" y="60" fill="#34d399" fontSize="14" fontFamily="monospace" className="animate-pulse">PLAYING: HIGHLIGHTS REEL</text>
              </g>
            ) : (
              <g>
                <circle cx="120" cy="175" r="12" fill="#ff6b35" opacity="0.5" />
                <circle cx="135" cy="165" r="6" fill="#ea580c" opacity="0.5" />
                <text x="210" y="190" fill="#fff" fontSize="18" fontFamily="sans-serif" fontWeight="bold">Video Paused // Click Play</text>
              </g>
            )}
          </svg>
        );
      case 'sde-binary':
        return (
          <svg viewBox="0 0 600 350" className="w-full h-full">
            <rect width="600" height="350" fill="#010d06" />
            <g stroke="#10b981" strokeWidth="2" opacity={isVideoPlaying ? "0.8" : "0.4"}>
            ...
            {isVideoPlaying ? (
              <g>
                ...
                <motion.circle 
                  cx="300" cy="50" r="16" fill="#022c22" stroke="#34d399" strokeWidth="2"
                  animate={{ scale: [1, 1.2, 1] }} transition={{ duration: 1.5, repeat: Infinity }}
                />
                <text x="292" y="55" fill="#34d399" fontSize="12" fontFamily="monospace" fontWeight="bold">99</text>

                <motion.circle 
                  cx="200" cy="120" r="16" fill="#022c22" stroke="#34d399" strokeWidth="2"
                  animate={{ scale: [1, 1, 1.2, 1] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.5 }}
                />
                <text x="192" y="125" fill="#34d399" fontSize="12" fontFamily="monospace" fontWeight="bold">24</text>
                
                <text x="380" y="280" fill="#34d399" fontSize="11" fontFamily="monospace">TIME_ELAPSED: 0.12ms</text>
                <text x="380" y="300" fill="#10b981" fontSize="11" fontFamily="monospace">COMPILATION: SUCCESSFUL</text>
              </g>
            ) : (
              <g>
                <circle cx="300" cy="50" r="16" fill="#022c22" stroke="#10b981" opacity="0.4" />
                <text x="210" y="250" fill="#fff" fontSize="18" fontFamily="sans-serif" fontWeight="bold">SDE Presentation Paused</text>
              </g>
            )}
          </svg>
        );
      default:
        ...
        return (
          <svg viewBox="0 0 600 350" className="w-full h-full">
            <rect width="600" height="350" fill="#02020f" />
            <g opacity={isVideoPlaying ? "1" : "0.5"}>
              {/* Plant Diagnostic frame */}
              <rect x="180" y="50" width="240" height="180" fill="none" stroke="#6366f1" strokeWidth="2" strokeDasharray="3,3" />
              <path d="M 300 210 Q 250 140 300 70 Q 350 140 300 210 Z" fill="#10b981" fillOpacity="0.15" stroke="#10b981" strokeWidth="2" />
              ...
              {isVideoPlaying ? (
                <g>
                  ...
                  <text x="200" y="210" fill="#10b981" fontSize="12" fontFamily="monospace">CONFIDENCE: 98.42%</text>
                </g>
              ) : (
                <text x="240" y="280" fill="#fff" fontSize="18" fontFamily="sans-serif" fontWeight="bold">Click Play walkthrough</text>
              )}
            </g>
          </svg>
        );
  ...
  return (
    <div className="space-y-12 py-4 animate-fade-in" id="humanized-gallery">
      ...
      <div 
        className="rounded-3xl border p-8 sm:p-10 relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-950 to-slate-950 shadow-2xl" 
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-4">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border text-[9px] font-mono tracking-wider uppercase bg-indigo-500/5 border-indigo-500/20 text-indigo-400">
              ...
              <span>Behind The Code Frame</span>
            </span>
            <h2 className="text-3xl sm:text-6xl font-black tracking-tight" style={{ color: colors.text }}>
              Gallery & Moments
            </h2>
            <p className="text-xs sm:text-base max-w-2xl text-slate-400 font-sans leading-relaxed">
          ...
          <div className="flex gap-1 bg-slate-950 p-1.5 rounded-full border border-slate-800 shrink-0 font-mono text-xxs">
            <button 
              onClick={() => setActiveTab('photos')}
              className={`px-4 py-2 rounded-full cursor-pointer font-bold ${activeTab === 'photos' ? 'bg-indigo-500 text-white' : 'text-slate-400 hover:text-white'}`}
            >
              Moments Masonry
            </button>
            <button 
              onClick={() => setActiveTab('videos')}
              className={`px-4 py-2 rounded-full cursor-pointer font-bold ${activeTab === 'videos' ? 'bg-indigo-500 text-white' : 'text-slate-400 hover:text-white'}`}
            >
              Simulated Logs
            </button>
            <button 
              onClick={() => setActiveTab('timeline')}
              className={`px-4 py-2 rounded-full cursor-pointer font-bold ${activeTab === 'timeline' ? 'bg-indigo-500 text-white' : 'text-slate-400 hover:text-white'}`}
            >
              Refinement Timeline
            </button>
          </div>
              ...
              {filteredPhotos.map((item) => (
                ...
                >
                  ...
                  <div 
                    ...
                    className="relative overflow-hidden cursor-zoom-in bg-slate-950 border-b flex items-center justify-center"
                    style={{ borderColor: colors.borderColor }}
                  >
                  ...
                  <div className="p-5 space-y-3">
                    <div className="flex justify-between items-center text-[10px] font-mono text-slate-400">
                      ...
                      <span className="text-indigo-400 font-bold">.{item.id.toUpperCase()}</span>
                    </div>

                    <h3 
                      onClick={() => setLightboxId(item.id)}
                      className="text-sm font-black text-slate-100 hover:text-indigo-400 transition-colors cursor-zoom-in"
                    ...
                    <div className="pt-3 border-t border-dashed flex justify-between items-center text-slate-300" style={{ borderColor: colors.borderColor }}>
                      <div className="flex items-center gap-3">
                        ...
                        <button 
                          ...
                          className={`flex items-center gap-1 cursor-pointer transition-transform duration-200 hover:scale-110 active:scale-95 ${item.isLiked ? 'text-rose-500 font-bold' : 'text-slate-400 hover:text-white'}`}
                        >
                        ...
                        <button 
                          onClick={() => setLightboxId(item.id)}
                          className="flex items-center gap-1 cursor-zoom-in text-slate-400 hover:text-white"
                        >
                      ...
                      <div className="flex items-center gap-2 relative">
                        ...
                        <button 
                          ...
                          className={`p-1 cursor-pointer hover:scale-110 active:scale-95 ${item.isBookmarked ? 'text-amber-400' : 'text-slate-400 hover:text-white'}`}
                        >
                        ...
                        <button 
                          ...
                          className="p-1 cursor-pointer hover:scale-110 text-slate-400 hover:text-white"
                        >
                    ...
                    {item.comments.length > 0 && (
                      <div className="mt-2.5 bg-slate-950/40 p-2.5 rounded-xl border space-y-1.5" style={{ borderColor: colors.borderColor }}>
                        {item.comments.slice(0, 1).map((c, i) => (
                          <div key={i} className="text-[10px] leading-relaxed">
                            <span className="font-mono text-indigo-400 font-extrabold mr-1.5">@{c.user}</span>
                        ...
                        {item.comments.length > 1 && (
                          <button 
                            onClick={() => setLightboxId(item.id)}
                            className="text-[9px] font-mono text-slate-500 font-bold block pt-1 hover:text-indigo-400"
                          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            >
              ...
              <div className="p-4 bg-slate-950 border-t flex flex-col gap-3 relative" style={{ borderColor: colors.borderColor }}>
                ...
                <div className="flex justify-between items-center text-xs font-mono">
                  <div className="flex items-center gap-3">
                    <button 
                      ...
                      className="p-1.5 hover:bg-slate-900 rounded-lg text-slate-300 hover:text-white cursor-pointer"
                    >
                    ...
                    <div className="flex items-center gap-1.5 text-xxs text-slate-500">
                      <span className="text-indigo-400">00:{Math.floor(videoProgress * 0.05)}</span>
                      <span>/</span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input 
                        ...
                        className="w-16 h-1 bg-slate-800 accent-indigo-500 rounded-lg appearance-none cursor-pointer" 
                      />
                    </div>

                    <span className="text-[10px] text-slate-500 px-1 border border-slate-800 rounded">
                      1080p LOG
                    </span>
                  </div>
                </div>
            ...
            <div className="p-6 bg-slate-950 rounded-2xl border space-y-2" style={{ borderColor: colors.borderColor }}>
              <span className="text-[8px] font-mono tracking-widest text-indigo-400 bg-indigo-500/5 px-2 py-0.5 rounded border border-indigo-500/20">
          ...
          <div className="lg:col-span-4 bg-slate-950 p-6 rounded-3xl border space-y-4" style={{ borderColor: colors.borderColor }}>
            <span className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold block border-b border-dashed pb-2">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3.5 rounded-2xl border transition-all cursor-pointer flex gap-3 ${
                      isActive ? 'bg-indigo-500/10 border-indigo-500/30' : 'bg-slate-900/40 border-slate-800 hover:border-slate-700'
                    }`}
                  >
                    <div className="p-3 bg-slate-950 rounded-xl flex items-center justify-center border border-slate-800 shrink-0 text-indigo-400">
                      <Video className="w-4 h-4" />
                    </div>

                    <div className="flex-1 min-w-0">
                      <span className="text-[9px] font-mono text-slate-500 block">{vid.duration} mins // {vid.category}</span>
                      <h4 className={`text-xs font-bold truncate ${isActive ? 'text-indigo-300' : 'text-slate-300'}`}>
                        {vid.title}
                      </h4>
                      <p className="text-[10px] text-slate-500 truncate block mt-0.5">{vid.description}</p>
                    </div>
                  </button>
                );
              })}
      ...
      {activeTab === 'timeline' && (
        <div className="p-6 sm:p-10 rounded-3xl border bg-slate-950/20 max-w-4xl mx-auto" style={{ borderColor: colors.borderColor }}>
          <div className="border-b pb-4 mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            <div className="space-y-1">
              <span className="text-[9px] font-mono uppercase tracking-widest text-indigo-400 font-bold block">
                Humanized Narrative Path
              </span>
              <h3 className="text-xl font-black text-slate-100" style={{ color: colors.text }}>Persistent Chronicles</h3>
            </div>
          ...
          <div className="relative pl-8 space-y-10">
            ...
            <div className="absolute left-[15px] top-3 bottom-3 w-0.5 bg-gradient-to-b from-indigo-500 via-indigo-500/30 to-slate-800 pointer-events-none" />
            ...
            {memoriesTimeline.map((item, idx) => (
              <div key={idx} className="relative group flex flex-col md:flex-row gap-4 items-start transition-transform duration-200 hover:-translate-y-0.5">
                {/* Node indicator */}
                <div className="absolute -left-[25px] w-5 h-5 rounded-full border-2 bg-slate-950 z-10 flex items-center justify-center border-indigo-500 group-hover:scale-110 transition-transform shadow-lg">
                  <div className="w-2 h-2 rounded-full bg-indigo-400" />
                </div>

                {/* Left side year tag */}
                <div className="w-24 shrink-0 font-mono text-lg font-black text-indigo-400">
                  {item.year}
                </div>
                ...
                >
                  <span className="text-[9px] font-mono text-slate-500 uppercase block">{item.subtitle}</span>
                  <h4 className="text-sm font-black text-slate-200 mt-0.5 leading-tight">{item.title}</h4>
      ...
      {lightboxId && activeLightboxItem && (
        <div 
          className="fixed inset-0 bg-slate-950/95 backdrop-blur-sm z-[9999] flex items-center justify-center p-4 sm:p-6"
          id="gallery-lightbox"
        >
          {/* Close back */}
          <button 
            onClick={() => setLightboxId(null)}
            className="absolute top-4 right-4 p-2 bg-slate-900 border border-slate-800 rounded-full hover:bg-slate-800 text-slate-400 hover:text-white cursor-pointer z-50 shadow-md"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          >
            ...
            <div className="md:col-span-7 bg-slate-950 flex flex-col justify-between relative min-h-[300px] md:h-full border-b md:border-b-0 md:border-r" style={{ borderColor: colors.borderColor }}>
              ...
              <button 
                ...
                className="absolute left-3 top-1/2 -translate-y-1/2 p-2 bg-black/60 hover:bg-black/90 rounded-full text-white cursor-pointer scale-90 md:scale-100"
              >
                <ChevronLeft className="w-5 h-5" />
              </button>
              <button 
                onClick={(e) => { e.stopPropagation(); navigateLightbox('next'); }}
                className="absolute right-3 top-1/2 -translate-y-1/2 p-2 bg-black/60 hover:bg-black/90 rounded-full text-white cursor-pointer scale-90 md:scale-100"
              >
                <ChevronRight className="w-5 h-5" />
              </button>

              <div className="p-4 bg-slate-950/80 border-t border-dashed flex justify-between items-center text-slate-300" style={{ borderColor: colors.borderColor }}>
                <span className="text-[10px] font-mono">Simulated Vector Proof // High Fidelity SVG</span>
                <span className="text-indigo-400 font-mono text-[9px]">ID: #{activeLightboxItem.id.toUpperCase()}</span>
              </div>
            </div>

            {/* Right side: Detailed Instagram profile context commenting (5 columns) */}
            <div className="md:col-span-5 flex flex-col h-full bg-slate-950/40 divide-y divide-dashed divide-slate-800" style={{ borderColor: colors.borderColor }}>
              
              {/* Creator Header */}
              <div className="p-5 flex justify-between items-center bg-slate-900/10">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-full bg-indigo-500/20 text-indigo-400 flex items-center justify-center font-mono font-bold text-xxs border border-indigo-500/30">
                    MB
                  </div>
                  <div>
                    <span className="text-xs font-black text-slate-100 block">@Manamoy_Banerjee</span>
                    <span className="text-[9px] font-mono text-indigo-400 leading-none block">AI Engineer • CSE Student</span>
                  </div>
                </div>

                <span className="text-[8px] font-mono text-slate-500">2019 — 2025 STAGE</span>
              </div>
              ...
              <div className="p-5 overflow-y-auto space-y-4 flex-1 custom-scrollbar">
                <div className="space-y-1">
                  ...
                  <span className="text-[10px] font-mono text-slate-400">{activeLightboxItem.date} // Category: {activeLightboxItem.category}</span>
                </div>
                ...
                <div className="space-y-3 pt-3 border-t border-slate-800">
                  ...
                  {activeLightboxItem.comments.length === 0 ? (
                    <span className="text-[10px] font-mono text-slate-500 italic block py-3">No posts yet. Place a professional query comment below!</span>
                  ) : (
                    <div className="space-y-2.5">
                      {activeLightboxItem.comments.map((c, idx) => (
                        <div key={idx} className="flex gap-2.5 items-start text-[10px] leading-relaxed">
                          <span className={`w-5 h-5 rounded-full bg-slate-800 flex items-center justify-center font-mono text-[8px] shrink-0 font-bold ${c.user === 'You_Recruiter' ? 'text-emerald-400 border border-emerald-500/20 bg-emerald-500/5' : 'text-slate-400'}`}>
                            {c.user.slice(0, 2).toUpperCase()}
                          </span>
                          <div className="flex-1 bg-slate-900/30 p-2 rounded-xl border border-slate-800">
                            <span className="font-mono text-indigo-300 font-bold mr-1">@{c.user}</span>
              ...
              <div className="p-5 bg-slate-950 space-y-3 shrink-0">
                <div className="flex justify-between items-center text-slate-300">
                  <div className="flex gap-4">
                    ...
                    >
                      ...
                      <span className="text-[10px] font-mono">{activeLightboxItem.likes}</span>
                    </button>
                    <span className="text-[10px] font-mono text-slate-400 flex items-center gap-1 py-1">
                ...
                <div className="flex items-center gap-2 pt-1">
                  <input
                    ...
                    className="flex-1 bg-slate-900 border border-slate-800 focus:border-indigo-500 rounded-xl px-3.5 py-2 text-xxs font-mono text-slate-200 outline-none placeholder-slate-500"
                  />
                  <button
                    onClick={() => handleAddComment(activeLightboxItem.id)}
                    className="p-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl transition-all cursor-pointer shadow"
                  >
