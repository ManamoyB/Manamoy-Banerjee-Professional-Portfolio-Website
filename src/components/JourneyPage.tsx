...
export const JourneyPage: React.FC<JourneyPageProps> = ({ colors, theme }) => {
  ...
  const renderSimulatedPhoto = (type: string) => {
    switch(type) {
      case 'school':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full bg-slate-950">
            ...
            <g opacity="0.15" stroke="#4f46e5" strokeWidth="1">
            ...
            <circle cx="200" cy="150" r="80" fill="none" stroke="#4f46e5" strokeWidth="1.5" strokeDasharray="4,4" />
            <circle cx="200" cy="150" r="40" fill="none" stroke="#818cf8" strokeWidth="2" />
            {/* Textbook formulas */}
            <text x="180" y="155" fill="#818cf8" fontSize="12" fontFamily="monospace" fontWeight="bold">∫ f(x)dx</text>
            <text x="50" y="70" fill="#4f46e5" fontSize="10" fontFamily="monospace">E = mc²</text>
            <text x="280" y="240" fill="#4f46e5" fontSize="10" fontFamily="monospace">F = ma</text>
            ...
            <text x="190" y="100" fill="#10b981" fontSize="8" fontFamily="monospace">Max Vector</text>
          </svg>
        );
      case 'basketball':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full bg-slate-950">
            <rect width="400" height="300" fill="#0a0502" />
            <path d="M -50 150 Q 100 20 200 150 T 450 150" fill="none" stroke="#ff6b35" strokeWidth="2" strokeOpacity="0.4" />
            <path d="M -50 150 Q 100 280 200 150 T 450 150" fill="none" stroke="#ff6b35" strokeWidth="2" strokeOpacity="0.4" />
            {/* Court layout markings */}
            <rect x="50" y="50" width="300" height="200" fill="none" stroke="#f43f5e" strokeWidth="1.5" strokeOpacity="0.3" />
            <circle cx="200" cy="150" r="50" fill="none" stroke="#f43f5e" strokeWidth="1.5" strokeOpacity="0.3" />
            <path d="M 50 150 A 50 50 0 0 0 150 150" fill="none" stroke="#f43f5e" strokeWidth="1.5" strokeOpacity="0.3" />
            <path d="M 350 150 A 50 50 0 0 0 250 150" fill="none" stroke="#f43f5e" strokeWidth="1.5" strokeOpacity="0.3" />
            {/* Schematic plays */}
            <circle cx="140" cy="110" r="6" fill="none" stroke="#ff8200" strokeWidth="2" />
            <text x="137" y="114" fill="#ff8200" fontSize="10" fontFamily="sans-serif" fontWeight="bold">X</text>
            <circle cx="180" cy="170" r="6" fill="none" stroke="#ff8200" strokeWidth="2" />
            <text x="177" y="174" fill="#ff8200" fontSize="10" fontFamily="sans-serif" fontWeight="bold">X</text>
            <circle cx="260" cy="130" r="6" fill="none" stroke="#22c55e" strokeWidth="2" />
            <text x="257" y="134" fill="#22c55e" fontSize="10" fontFamily="sans-serif" fontWeight="bold">O</text>
            {/* Passing vector dashed line */}
            <path d="M 146 114 Q 200 110 254 126" fill="none" stroke="#3b82f6" strokeWidth="2" strokeDasharray="5,5" />
            <polygon points="255,127 247,122 250,131" fill="#3b82f6" />
          </svg>
        );
      case 'coding':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full bg-slate-950">
            <rect width="400" height="300" fill="#020804" />
            <g opacity="0.3" stroke="#22c55e" strokeWidth="0.5" fontFamily="monospace" fontSize="8" fill="#10b981">
              <text x="20" y="30">{`>>> import sys`}</text>
              <text x="20" y="45">{`>>> def compute_growth(x):`}</text>
              <text x="40" y="60">{`return (x * 12.8) / 0.15`}</text>
              <text x="20" y="75">{`>>> print(compute_growth(100))`}</text>
              <text x="20" y="90">{`8533.333333333333`}</text>
              <text x="20" y="120">{`SYS_INIT_SEQUENCE // COMPLETE`}</text>
              <text x="20" y="135">{`IP_ADD 127.0.0.1 // DEV_STAGE`}</text>
            </g>
            {/* Visual retro monitor shape */}
            <rect x="100" y="160" width="200" height="100" rx="10" fill="none" stroke="#22c55e" strokeWidth="2" />
            <rect x="105" y="165" width="190" height="90" rx="5" fill="#042f1a" fillOpacity="0.2" />
            <path d="M 200 260 L 200 280 M 150 280 L 250 280" stroke="#22c55e" strokeWidth="2" />
            <text x="140" y="210" fill="#22c55e" fontSize="14" fontFamily="monospace" className="animate-pulse">HELLO WORLD</text>
          </svg>
        );
      case 'project':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full bg-slate-950">
            ...
            {/* DB schemas */}
            <rect x="50" y="50" width="100" height="85" rx="6" fill="#0f172a" stroke="#3b82f6" strokeWidth="1.5" />
            <text x="58" y="65" fill="#3b82f6" fontSize="10" fontFamily="monospace" fontWeight="bold">TBL_PLAYERS</text>
            <path d="M 50 72 L 150 72" stroke="#3b82f6" strokeWidth="1" />
            <text x="58" y="85" fill="#94a3b8" fontSize="8" fontFamily="monospace">PK | player_id [INT]</text>
            <text x="58" y="100" fill="#94a3b8" fontSize="8" fontFamily="monospace">   | name [VARCHAR]</text>
            <text x="58" y="115" fill="#94a3b8" fontSize="8" fontFamily="monospace">   | jersey_no [INT]</text>

            <rect x="250" y="160" width="100" height="85" rx="6" fill="#0f172a" stroke="#10b981" strokeWidth="1.5" />
            <text x="258" y="175" fill="#10b981" fontSize="10" fontFamily="monospace" fontWeight="bold">TBL_STATS</text>
            <path d="M 250 182 L 350 182" stroke="#10b981" strokeWidth="1" />
            <text x="258" y="195" fill="#94a3b8" fontSize="8" fontFamily="monospace">PK | stat_id [INT]</text>
            <text x="258" y="210" fill="#94a3b8" fontSize="8" fontFamily="monospace">FK | player_id [INT]</text>
            <text x="258" y="225" fill="#94a3b8" fontSize="8" fontFamily="monospace">   | points [INT]</text>

            {/* Relationship line */}
            <path d="M 150 92 L 200 92 L 200 202 L 250 202" fill="none" stroke="#f59e0b" strokeWidth="1.5" strokeDasharray="3,3" />
            <circle cx="150" cy="92" r="3" fill="#f59e0b" />
            <circle cx="250" cy="202" r="3" fill="#f59e0b" />
            <text x="175" y="145" fill="#f59e0b" fontSize="8" fontFamily="monospace">1 : N</text>
          </svg>
        );
      case 'ai':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full bg-slate-950">
            <rect width="400" height="300" fill="#07020d" />
            {/* Multi-layered neural nodes visual */}
            <g stroke="#ec4899" strokeWidth="0.5" strokeOpacity="0.4">
              {/* Layer 1 Nodes */}
            ...
            {/* Draw overlay nodes */}
            <circle cx="100" cy="80" r="8" fill="#d946ef" />
            <circle cx="100" cy="150" r="8" fill="#d946ef" />
            <circle cx="100" cy="220" r="8" fill="#d946ef" />
            
            <circle cx="200" cy="80" r="8" fill="#a855f7" />
            <circle cx="200" cy="150" r="8" fill="#a855f7" />
            <circle cx="200" cy="220" r="8" fill="#a855f7" />
            
            <circle cx="300" cy="115" r="8" fill="#e11d48" />
            <circle cx="300" cy="185" r="8" fill="#e11d48" />
            
            <text x="80" y="270" fill="#e11d48" fontSize="10" fontFamily="monospace">INPUT_DIM: [3]</text>
            <text x="250" y="270" fill="#a855f7" fontSize="10" fontFamily="monospace">LOSS: 0.012</text>
          </svg>
        );
      case 'research':
        return (
      ...
      case 'cert':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full bg-slate-950">
            <rect width="400" height="300" fill="#0e0a02" />
            <g opacity="0.15" stroke="#f59e0b" strokeWidth="1">
              <polygon points="200,50 350,150 200,250 50,150" fill="none" />
            </g>
            {/* Center concentric target matrix */}
            <circle cx="200" cy="150" r="60" fill="none" stroke="#f59e0b" strokeWidth="2" />
            ...
            <circle cx="280" cy="150" r="5" fill="#6366f1" />
            <circle cx="120" cy="150" r="5" fill="#6366f1" />
            
            <text x="145" y="275" fill="#f59e0b" fontSize="12" fontFamily="sans-serif" fontWeight="black">COGNIZANT PIPELINE</text>
          </svg>
        );
      case 'placement':
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full bg-slate-950">
            <rect width="400" height="300" fill="#0c0307" />
            ...
            {/* Node markers */}
            <circle cx="200" cy="50" r="14" fill="#1e1b4b" stroke="#db2777" strokeWidth="2" />
            <text x="194" y="54" fill="#fc2e91" fontSize="10" fontFamily="monospace" fontWeight="bold">99</text>

            <circle cx="120" cy="110" r="14" fill="#1e1b4b" stroke="#db2777" strokeWidth="2" />
            <text x="114" y="114" fill="#fc2e91" fontSize="10" fontFamily="monospace" fontWeight="bold">24</text>

            <circle cx="280" cy="110" r="14" fill="#1e1b4b" stroke="#db2777" strokeWidth="2" />
            <text x="274" y="114" fill="#fc2e91" fontSize="10" fontFamily="monospace" fontWeight="bold">150</text>

            <circle cx="70" cy="180" r="12" fill="#020617" stroke="#3b82f6" strokeWidth="1.5" />
            <text x="66" y="184" fill="#60a5fa" fontSize="8" fontFamily="monospace">11</text>

            <circle cx="170" cy="180" r="12" fill="#020617" stroke="#3b82f6" strokeWidth="1.5" />
            <text x="166" y="184" fill="#60a5fa" fontSize="8" fontFamily="monospace">35</text>

            <circle cx="230" cy="180" r="12" fill="#020617" stroke="#3b82f6" strokeWidth="1.5" />
            <text x="225" y="184" fill="#60a5fa" fontSize="8" fontFamily="monospace">110</text>

            <circle cx="330" cy="180" r="12" fill="#020617" stroke="#3b82f6" strokeWidth="1.5" />
            <text x="325" y="184" fill="#60a5fa" fontSize="8" fontFamily="monospace">400</text>

            <text x="40" y="260" fill="#db2777" fontSize="10" fontFamily="monospace">TIME_COMPLEXITY: O(log N)</text>
            <text x="240" y="260" fill="#3b82f6" fontSize="10" fontFamily="monospace">SDE_PREP_STATUS: SPRINT_9</text>
          </svg>
        );
      default:
        ...
        return (
          <svg viewBox="0 0 400 300" className="w-full h-full bg-slate-950">
            <rect width="400" height="300" fill="#020d08" />
            <g opacity="0.1" stroke="#10b981" strokeWidth="0.5">
              <line x1="0" y1="0" x2="400" y2="300" />
              <line x1="400" y1="0" x2="0" y2="300" />
            </g>
            {/* Decentralized modular layout flow block */}
            <rect x="50" y="90" width="80" height="60" rx="8" fill="#064e3b" fillOpacity="0.4" stroke="#10b981" strokeWidth="1.5" />
            <text x="58" y="115" fill="#10b981" fontSize="9" fontFamily="monospace" fontWeight="black">USER_INTENT</text>
            <text x="58" y="130" fill="#6ee7b7" fontSize="7" fontFamily="monospace">Parsing vector</text>
            
            <rect x="270" y="90" width="80" height="60" rx="8" fill="#1e1b4b" fillOpacity="0.4" stroke="#6366f1" strokeWidth="1.5" />
            <text x="278" y="115" fill="#818cf8" fontSize="9" fontFamily="monospace" fontWeight="black">REASON_GEN</text>
            <text x="278" y="130" fill="#a5b4fc" fontSize="7" fontFamily="monospace">Fitted logic</text>
            
            {/* Core orchestrator block */}
            <circle cx="200" cy="180" r="30" fill="#030712" stroke="#f59e0b" strokeWidth="2" />
            <text x="180" y="184" fill="#f59e0b" fontSize="10" fontFamily="monospace" fontWeight="black">EXEC_API</text>
            ...
            <text x="140" y="270" fill="#10b981" fontSize="10" fontFamily="monospace">AUTONOMOUS MULTI-AGENT</text>
          </svg>
        );
    }
  };
  ...
  return (
    <div className="space-y-12 py-4 animate-fade-in" id="career-journey">
      ...
      <div 
        className="rounded-3xl border p-8 sm:p-10 relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-950 to-slate-950 shadow-xl" 
      ...
      >
        ...
        <div className="relative z-10 space-y-4">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border text-[9px] font-mono tracking-wider uppercase bg-indigo-500/5 border-indigo-500/20 text-indigo-400">
            ...
            <span>Curated Development Narrative</span>
          </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-4 bg-slate-950/40 p-4 sm:p-6 rounded-3xl border relative overflow-hidden" style={{ borderColor: colors.borderColor }}>
          ...
          <div className="pb-3 border-b border-dashed flex justify-between items-center" style={{ borderColor: colors.borderColor }}>
            ...
            <span className="text-[9px] font-mono text-indigo-400 bg-indigo-500/5 px-2 py-0.5 rounded border border-indigo-500/20">
              Interactive Index
            </span>
          </div>
          ...
          <div className="relative pl-6 space-y-3 pt-2">
            ...
            <div className="absolute left-[11px] top-4 bottom-4 w-0.5 bg-slate-800 pointer-events-none" />
            ...
            {milestones.map((m) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left relative flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 group cursor-pointer ${
                    isSelected 
                      ? 'bg-slate-900 shadow border-slate-700/50' 
                      : 'hover:bg-slate-900/30 border-transparent'
                  } border`}
                >
                  {/* Timeline point node */}
                  <div className={`absolute -left-[20px] w-4 h-4 rounded-full border-2 bg-slate-950 z-10 flex items-center justify-center transition-all ${
                    isSelected ? 'border-indigo-500 scale-110' : 'border-slate-800'
                  }`}>
                    <div className={`w-1.5 h-1.5 rounded-full ${isSelected ? 'bg-indigo-400' : 'bg-transparent'}`} />
                  </div>

                  <div className={`p-2.5 rounded-xl border flex items-center justify-center shrink-0 transition-transform ${
                    isSelected ? 'bg-indigo-500/10 border-indigo-500/30' : 'bg-slate-950 border-slate-800 group-hover:scale-105'
                  }`}>
                    <MIcon className={`w-4 h-4 ${isSelected ? 'text-indigo-400' : 'text-slate-500'}`} />
                  </div>

                  <div className="flex-1 min-w-0 pr-1">
                    <span className="text-[9px] font-mono opacity-50 block">{m.period}</span>
                    <h4 className="text-xs font-bold leading-tight text-slate-100 truncate mt-0.5" style={{ color: isSelected ? colors.primary : undefined }}>
                      {m.title}
                    </h4>
                    <span className="text-[10px] text-slate-400 truncate block mt-0.5">{m.subtitle}</span>
                  </div>

                  <ChevronRight className={`w-4 h-4 transition-transform text-slate-600 shrink-0 ${isSelected ? 'translate-x-0.5 text-indigo-400' : 'opacity-0 group-hover:opacity-100'}`} />
                </button>
              );
            })}
          </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4 pb-4 border-b border-dashed" style={{ borderColor: colors.borderColor }}>
              <div className="space-y-1">
                <span className={`inline-flex items-center gap-1 text-[8px] font-mono font-bold uppercase tracking-widest px-2.5 py-0.5 rounded border border-indigo-500/20 bg-indigo-500/5 text-indigo-400`}>
                ...
                <span className="text-xs text-slate-400 block font-medium">{activeMilestone.subtitle}</span>
              </div>

              {/* Graphical milestone index marker */}
              <div className="p-3 bg-slate-950 rounded-2xl border flex items-center justify-center font-mono text-[9px] shrink-0" style={{ borderColor: colors.borderColor }}>
                <span className="text-slate-500">INDEX.ID // </span>
                <span className="font-bold text-indigo-400 ml-1">.{activeMilestone.id.toUpperCase()}</span>
              </div>
            </div>

            {/* Description Paragraph */}
            <p className="text-xs text-slate-300 leading-relaxed font-sans max-w-full">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {activeMilestone.achievements.map((ach, idx) => (
                  <div 
                    key={idx} 
                    className="flex items-start gap-3 p-3 bg-slate-950 border rounded-xl hover:border-slate-800 transition-colors"
                    style={{ borderColor: colors.borderColor }}
                  >
                    <span className="font-mono font-extrabold text-indigo-400 bg-indigo-500/5 w-5 h-5 rounded-full flex items-center justify-center shrink-0 text-[10px]">
                      0{idx + 1}
                    </span>
                    <p className="text-xs text-slate-300 pt-0.5 leading-relaxed">{ach}</p>
                  </div>
                ))}
              </div>
            </div>
              ...
              >
                {flippedPhoto !== activeMilestone.id ? (
                  ...
                  <div className="absolute inset-0 flex flex-col h-full bg-white p-3 sm:p-4 text-slate-800 transition-all duration-300 transform group-hover:scale-[0.99] hover:bg-slate-50">
                    <div className="flex-1 rounded-lg overflow-hidden border border-slate-200 shadow-inner bg-slate-950 relative">
                  ...
                  <div className="absolute inset-0 bg-slate-950 text-slate-300 p-6 sm:p-8 flex flex-col justify-between border-2 border-indigo-500/50">
                    <div className="space-y-3 pt-2">
                      <span className="text-[8px] font-mono font-bold uppercase tracking-widest text-indigo-400 flex items-center gap-1">
                        <MessageSquare className="w-3 h-3" />
                        Aesthetic Backstory context
                      </span>
                      <h4 className="text-sm font-bold text-slate-200">The Reflection behind "{activeMilestone.title}"</h4>
                      <p className="text-[11px] leading-relaxed text-slate-400 font-sans">
                        This specific milestone represent a crucial pivot point. In physical basketball arenas, I learned the importance of immediate, authoritative feedback loops, coordination under heavy score deficits, and standard performance metrics. Translating that identical conditioning into algorithmic complexities, compiling codes, and neural matrixes allows me to construct more resilient predictive layers.
                      </p>
                    </div>

                    <div className="border-t border-dashed pt-4 flex justify-between items-center text-[9px] font-mono text-slate-500" style={{ borderColor: colors.borderColor }}>
